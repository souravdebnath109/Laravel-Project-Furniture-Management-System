      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="basic-form">
            <form action="{{url('_user/addtocart/'.$item->id)}}" method="POST">
              @csrf
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label style="font-weight: bold">Image</label>

                  <img src="{{asset('Furnixure/furniture/'.$item->photo_path)}}" style="width:90px;height:90px">
                  {{-- <input type="file" class="form-control" placeholder="imagepath"> --}}
                </div>
                <div class="form-group col-md-6">
                  <label style="font-weight: bold">Product</label>
                  <input type="text" class="form-control" placeholder="product" value="{{$item->title}}" readonly>
                </div>
                <div class="form-group col-md-6">
                  <label style="font-weight: bold">Price</label>
                  <input type="text" class="form-control" placeholder="price" value="{{$item->price}}" readonly>
                </div>
                <div class="form-group col-md-6">
                  <label style="font-weight: bold">Quantity</label>
                  <div class="input-group mb-2 d-flex align-items-center quantity-container" style="max-width: 100px;">
                    <input type="number" class="form-control text-center quantity-amount" value="1" placeholder=""
